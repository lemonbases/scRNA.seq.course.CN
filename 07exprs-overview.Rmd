...
```
```{r norm-ours-rle-cpm-reads, fig.cap = "Cell-wise RLE of the tung data",echo=FALSE}
...
```
```{r norm-ours-rle-scran-reads, fig.cap = "Cell-wise RLE of the tung data",echo=FALSE}
...
```
```{r norm-ours-rle-downsample-reads, fig.cap = "Cell-wise RLE of the tung data",echo=FALSE}
